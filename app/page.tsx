export default function Home() {
  return (
    <main className="page">
      ...
      <header className="sticky flex top-3 justify-between mx-8 mt-5  ">
      ...
      <h1 className="text-center text-[96px] font-extrabold sticky -top-6 ">PIN-POP</h1>
      ...
      <section className="container flex justify-center gap-15 my-80">
        ...
        <div className="flex flex-col justify-between gap-10 ">
          ...
          <div className="image-card hero-wide bg-[#EA2E00] text-white">
            Image
          </div>
